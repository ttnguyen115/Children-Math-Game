...
let randomQuestion = () =>
{
    ...
    document.getElementById("container" + correctAnswerPosition).innerHTML = subResult; // fill one box with one correct answer

    // fill other boxes with different wrong answer
    var answer = [subResult];
    for (let i = 1; i < 11; i++)
    {
        if (i != correctAnswerPosition)
        {
            ...
            while (answer.indexOf(wrongAnswer) > -1 || wrongAnswer < 0); 
